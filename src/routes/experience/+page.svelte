...
<main class={theme}>
  ...
  <!-- Pengalaman -->
  <section class="section experience" id="experience" transition:slide>
    <h2><b>Pengalaman Bekerja</b></h2>
    <div class="experience-grid">
      <div class="experience-card">
        <h3>Almeerasadadiuna Perdana</h3>
        <p>Pernah bekerja di Almeerasadadiuna Perdana.</p>
      </div>
      <div class="experience-card">
        <h3>Dalang.io</h3>
        <p>Sedang bekerja di Dalang.io.</p>
      </div>
    </div>
  </section>
